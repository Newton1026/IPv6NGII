...
QString Myapp::winPortName = "COM10";                   //Win默认串口号
QString Myapp::linuxPortName = "ttyS0";               //linux默认串口号
...
QString Myapp::SoftTitle = QString::fromLocal8Bit("基于6LoWPAN的智能家居控制系统");
QString Myapp::SoftVersion = "V1.0";
QString Myapp::CompanyName = QString::fromLocal8Bit("Shenzhen University");
QString Myapp::ContactName = QString::fromLocal8Bit("newton");
QString Myapp::ContactTel = "15019203230";
