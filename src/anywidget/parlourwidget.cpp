...
//预设温度值，湿度值
int set_parlour_tempture = 20;
int set_parlour_humidity = 10;
    ...
    ui(new Ui::Parlourwidget)
{
    ...
    this->init();
    this->initConnect();
    this->refreshSensorDefaultValue();
}
...
void Parlourwidget::slotAddTempture()
{
    set_parlour_tempture++;
    refreshSensorDefaultValue();
}

void Parlourwidget::slotSubTempture()
{
    if (set_parlour_tempture > 0)
        set_parlour_tempture--;
    refreshSensorDefaultValue();
}

void Parlourwidget::slotAddHumidity()
{
    if (set_parlour_humidity < 60)
        set_parlour_humidity++;
    refreshSensorDefaultValue();
}

void Parlourwidget::slotSubHumidity()
{
    if (set_parlour_humidity > 0)
        set_parlour_humidity--;
    refreshSensorDefaultValue();
}
